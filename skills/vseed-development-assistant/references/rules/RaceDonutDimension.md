# RaceDonutDimension 配置约束与规则

> **适用图表类型**：`raceDonut`（动态环形图）

本文档说明 `raceDonut` 图表类型的 **dimensions 配置规则与约束**。

---

## 类型定义

详见 [type-details/RaceDonutDimension.md](../type-details/RaceDonutDimension.md)
...
2. **分类维度** → `encoding: 'color'`（环形扇区分类，如产品类别、地区，必需）
