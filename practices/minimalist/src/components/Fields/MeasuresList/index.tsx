...
import { PlusOutlined, DragOutlined, DownOutlined, UpOutlined, SettingOutlined, DeleteOutlined } from '@ant-design/icons';
import { useVBIStore } from 'src/model';

type FieldItem = { name: string; type: string };

export const MeasuresList = memo(({ style }: { style?: React.CSSProperties }) => {
  ...
  return (
    <div style={{ height: 44, position: 'relative', width: '100%', zIndex: expanded ? 90 : 5, ...style }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
          ...
          <div style={{ width: '1px', backgroundColor: '#e8e8e8', height: '24px', margin: '2px 4px 0 4px' }} />
