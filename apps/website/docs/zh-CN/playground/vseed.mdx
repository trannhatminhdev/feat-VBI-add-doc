...
const Demo = () => {
  ...
  const vseed: VSeed = {
    ...
    dataset: [
      { date: '2019', region: 'east', profit: 1, sales: 1 },
      { date: '2020', region: 'east', profit: 2, sales: 2 },
      { date: '2021', region: 'east', profit: 3, sales: 3 },
      { date: '2022', region: 'east', profit: 4, sales: 4 },
      { date: '2023', region: 'east', profit: 5, sales: 5 },

      { date: '2019', region: 'north of east', profit: 9, sales: 6 },
      { date: '2020', region: 'north of east', profit: 8, sales: 5 },
      { date: '2021', region: 'north of east', profit: 7, sales: 4 },
      { date: '2022', region: 'north of east', profit: 4, sales: 3 },
      { date: '2023', region: 'north of east', profit: 1, sales: 2 },
    ],
    player: {
      field: 'date',
      interval: 1000,
