...
import config_7 from './chartType/simple.json'
import config_8 from './chartType/standard.json'
import config_9 from './combination/basic.json'
import config_10 from './dataset/onlyDimensions.json'
...
import config_14 from './pivotGrid/pivotBasicV3.json'
import config_15 from './pivotGrid/pivotBasicV4.json'
...
const cases = [
  ...
  { name: 'chartType/simple', vseed: config_7 },
  { name: 'chartType/standard', vseed: config_8 },
  { name: 'combination/basic', vseed: config_9 },
  { name: 'dataset/onlyDimensions', vseed: config_10 },
  ...
  { name: 'pivotGrid/pivotBasicV3', vseed: config_14 },
  { name: 'pivotGrid/pivotBasicV4', vseed: config_15 }
]
