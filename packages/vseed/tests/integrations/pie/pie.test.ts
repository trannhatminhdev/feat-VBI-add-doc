...
import config_0 from './chartType/combinationPie-color.json'
import config_1 from './chartType/has-parentId-and-color.json'
import config_2 from './chartType/has-parentId-combination.json'
import config_3 from './chartType/minimal.json'
import config_4 from './chartType/pivotPie-has-empty.json'
import config_5 from './chartType/pivotPie-label.json'
...
import config_13 from './label/labelLayout.json'
import config_14 from './pivotGrid/pivotBasic.json'
import config_15 from './pivotGrid/pivotBasicV2.json'
import config_16 from './tooltip/pie.json'

const cases = [
  { name: 'chartType/combinationPie-color', vseed: config_0 },
  { name: 'chartType/has-parentId-and-color', vseed: config_1 },
  { name: 'chartType/has-parentId-combination', vseed: config_2 },
  { name: 'chartType/minimal', vseed: config_3 },
  { name: 'chartType/pivotPie-has-empty', vseed: config_4 },
  { name: 'chartType/pivotPie-label', vseed: config_5 },
