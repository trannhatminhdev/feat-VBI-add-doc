...
import config_1 from './chartType/simple.json'
import config_2 from './chartType/standard.json'
import config_3 from './color/dimension.json'
import config_4 from './color/measure.json'
import config_5 from './combination/basic.json'
import config_6 from './combination/basicV2.json'
import config_7 from './dataset/onlyMeasures.json'
import config_8 from './pivotGrid/pivotBasic.json'
import config_9 from './pivotGrid/pivotBasicV2.json'

const cases = [
  { name: 'chartType/minimal', vseed: config_0 },
  { name: 'chartType/simple', vseed: config_1 },
  { name: 'chartType/standard', vseed: config_2 },
  { name: 'color/dimension', vseed: config_3 },
  { name: 'color/measure', vseed: config_4 },
  { name: 'combination/basic', vseed: config_5 },
  { name: 'combination/basicV2', vseed: config_6 },
  { name: 'dataset/onlyMeasures', vseed: config_7 },
  { name: 'pivotGrid/pivotBasic', vseed: config_8 },
  { name: 'pivotGrid/pivotBasicV2', vseed: config_9 }
]
