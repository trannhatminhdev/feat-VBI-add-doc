...
import config_0 from './chartType/detail.json'
...
import config_8 from './dataset/1m1d.json'
...
const cases = [
  { name: 'chartType/detail', vseed: config_0 },
  ...
  { name: 'dataset/1m1d', vseed: config_8 },
