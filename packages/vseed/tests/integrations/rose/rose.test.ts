...
import config_1 from './chartType/roseChartOnlyMeasures.json'
import config_2 from './chartType/simple.json'
import config_3 from './chartType/stackedRoseChart.json'
...
import config_7 from './combination/basic.json'
import config_8 from './combination/basicV2.json'
import config_9 from './dataset/onlyMeasures.json'
import config_10 from './pivotGrid/pivotBasic.json'
import config_11 from './pivotGrid/pivotBasicV2.json'

const cases = [
  { name: 'chartType/minimal', vseed: config_0 },
  { name: 'chartType/roseChartOnlyMeasures', vseed: config_1 },
  { name: 'chartType/simple', vseed: config_2 },
  { name: 'chartType/stackedRoseChart', vseed: config_3 },
  { name: 'chartType/standard', vseed: config_4 },
  { name: 'color/dimension', vseed: config_5 },
  { name: 'color/measure', vseed: config_6 },
  { name: 'combination/basic', vseed: config_7 },
  { name: 'combination/basicV2', vseed: config_8 },
  { name: 'dataset/onlyMeasures', vseed: config_9 },
  { name: 'pivotGrid/pivotBasic', vseed: config_10 },
  { name: 'pivotGrid/pivotBasicV2', vseed: config_11 }
]
